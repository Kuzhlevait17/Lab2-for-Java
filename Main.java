...
//                    System.out.println(newHome);
                    if (userInput == 0) {
                        ...
                        System.out.println(newHome);
                        // Попытка изменить СУЩЕСТВУЮЩИЙ объект - НЕВОЗМОЖНО:
                        //   newHome.setFloors(10);
                        //   newHome.floors = 10;

                        // Но можно создать НОВЫЙ объект:
                        // newHome = new HouseUpdate(10);  // Это НОВЫЙ дом
                        // System.out.println("Количество этажей в новом доме(уже ссылка на другой участок памяти)");
                        //System.out.println(newHome.getFloors()); // 10
                        // System.out.println(newHome);
                        System.out.println();
                    }
                    break;
